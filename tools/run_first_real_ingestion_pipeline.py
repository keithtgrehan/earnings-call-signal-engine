...
def run_first_real_ingestion_pipeline(
    *,
    ...
    summary: dict[str, Any] = {
        ...
        "retrieval_object_ready_calls": chunk_summary["retrieval_object_ready_calls"],
        "bm25_smoke_ready_calls": chunk_summary["bm25_smoke_ready_calls"],
        "evaluated_rag": False,
...
def _write_final_reports(summary: dict[str, Any], acquisition_report_dir: Path, retrieval_report_dir: Path, workspace: Path) -> None:
    ...
    lines = [
        ...
        "- evaluated_rag=false",
        f"- retrieval_eval_queries_run={summary['retrieval_eval_queries_run']}",
        "- retrieval_quality_proven=false",
