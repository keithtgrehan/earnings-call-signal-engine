...
def build_proof(out_dir: Path) -> dict[str, Any]:
    ...
    proof = {
        ...
        "canonical_demo_command": "python scripts/verify_outputs.py --out-dir outputs/PVH_2025_Q1_call09 --require-run-meta",
        "canonical_output_dir": "outputs/PVH_2025_Q1_call09",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build a machine-readable proof artifact for the canonical PVH demo."
    )
    parser.add_argument(
        "--out-dir",
        default=None,
        help="Output directory for the canonical case. Defaults to outputs/PVH_2025_Q1_call09.",
    )
    parser.add_argument(
        "--proof-path",
        default=None,
