...
LABEL_SOURCE = "human_seeded_v1"

SEED_SPECS: tuple[dict[str, Any], ...] = (
    {
        "id": "risk_support_refund_delay_001",
        "source_file": "data/signal_engine_2_0/sample_support.json",
        "domain": "support",
        ...
        "notes": "Full customer turn from the synthetic support sample.",
    },
    {
        "id": "risk_support_deflection_001",
        "source_file": "data/signal_engine_2_0/sample_support.json",
        "domain": "support",
        ...
        "notes": "Clause split from an agent deflection turn.",
    },
    {
        "id": "risk_support_escalation_001",
        "source_file": "data/signal_engine_2_0/sample_support.json",
        "domain": "support",
        ...
        "notes": "Full escalation turn from the support sample.",
    },
    {
        "id": "risk_sales_pricing_objection_001",
        "source_file": "data/signal_engine_2_0/sample_sales.json",
        "domain": "sales",
        ...
        "notes": "Full pricing-objection turn from the sales sample.",
    },
    {
        "id": "risk_account_unresolved_001",
        "source_file": "data/signal_engine_2_0/sample_account_management.json",
        ...
        "notes": "Clause split from a renewal-risk turn.",
    },
    {
        "id": "risk_account_vendor_risk_001",
        "source_file": "data/signal_engine_2_0/sample_account_management.json",
        "domain": "account_management",
        ...
        "notes": "Full churn-pressure turn from the account-management sample.",
    },
    {
        "id": "risk_support_billing_delay_001",
        "source_file": "data/signal_engine_2_0/fixtures/support_tickets_realistic.jsonl",
        "domain": "support",
        "text": "I'm frustrated that invoice 8842 still shows the wrong total and nobody has confirmed when the credit will post. Please send the update to dana.ops@northwind.example or call +1 415 555 0177.",
        "signal_family": "risk_friction",
        ...
        "notes": "Full realistic support turn; PII is redacted in the saved dataset.",
    },
    {
        ...
        "notes": "Realistic support deflection turn.",
    },
    {
        ...
        "notes": "Realistic support escalation turn.",
    },
    {
        "id": "risk_sales_procurement_block_001",
        "source_file": "data/signal_engine_2_0/fixtures/sales_calls_realistic.jsonl",
        "domain": "sales",
        ...
        "notes": "Realistic sales friction turn.",
    },
    {
        "id": "risk_account_reduce_seats_001",
        "source_file": "data/signal_engine_2_0/fixtures/account_management_realistic.jsonl",
        "domain": "account_management",
        ...
        "notes": "Realistic account-management risk turn.",
    },
    {
        "id": "risk_support_anger_seed_001",
        "source_file": "data/signal_engine_2_0/emotion_benchmark/sample_emotion_cases.jsonl",
        "domain": "support",
        ...
        "notes": "Emotion benchmark seed reused as a friction label.",
    },
    {
        "id": "opp_sales_pilot_interest_001",
        "source_file": "data/signal_engine_2_0/sample_sales.json",
        "domain": "sales",
        ...
        "notes": "Clause split from a buyer-interest turn.",
    },
    {
        "id": "opp_sales_plan_commitment_001",
        "source_file": "data/signal_engine_2_0/sample_sales.json",
        "domain": "sales",
        ...
        "notes": "Clause split from a rep commitment turn.",
    },
    {
        "id": "opp_sales_security_packet_001",
        "source_file": "data/signal_engine_2_0/sample_sales.json",
        "domain": "sales",
    ...
    {
        "id": "opp_sales_procurement_path_001",
        "source_file": "data/signal_engine_2_0/sample_sales.json",
        "domain": "sales",
        ...
        "notes": "Clause split from a buyer next-step turn.",
    },
    {
        "id": "opp_account_recovery_plan_001",
        "source_file": "data/signal_engine_2_0/sample_account_management.json",
        "domain": "account_management",
        ...
        "notes": "Full owner-commitment turn from the account-management sample.",
    },
    {
        "id": "opp_account_expand_support_001",
        "source_file": "data/signal_engine_2_0/sample_account_management.json",
        "domain": "account_management",
        ...
        "notes": "Clause split from a conditional expansion turn.",
    },
    {
        "id": "opp_account_confirm_owners_001",
        "source_file": "data/signal_engine_2_0/sample_account_management.json",
        "domain": "account_management",
        ...
        "notes": "Clause split from a follow-up commitment turn.",
    },
    {
        "id": "opp_account_own_recovery_001",
        "source_file": "data/signal_engine_2_0/fixtures/account_management_realistic.jsonl",
        "domain": "account_management",
        ...
        "notes": "Short ownership clause from the realistic account-management fixture.",
    },
    {
        "id": "opp_account_named_owners_001",
        "source_file": "data/signal_engine_2_0/fixtures/account_management_realistic.jsonl",
        "domain": "account_management",
        ...
        "notes": "Clause split from the realistic account-management recovery turn.",
    },
    {
        ...
        "notes": "Clause split from the realistic expansion-upside turn.",
    },
    {
        ...
        "notes": "Emotion benchmark satisfaction case reused as a resolution-positive signal.",
    },
    {
        ...
        "notes": "Emotion benchmark satisfaction case reused as a commitment-positive signal.",
    },
    {
        "id": "opp_sales_security_review_path_001",
        "source_file": "data/signal_engine_2_0/sample_sales.json",
        "domain": "sales",
        ...
        "notes": "Clause split from a buyer-interest turn; labeled conservatively as weak opportunity.",
    },
    {
        "id": "unc_support_waiting_update_001",
        "source_file": "data/signal_engine_2_0/sample_support.json",
        "domain": "support",
        "text": "We are still looking into it and someone will reach out later once billing has an update.",
        "signal_family": "uncertainty_hedging",
        ...
        "notes": "Full support follow-up turn with unresolved timing.",
    },
    {
    ...
    },
    {
        ...
        "notes": "Conditional clause from a next-step turn.",
    },
    {
        ...
        "notes": "Condition clause from an expansion turn.",
    },
    {
        ...
        "notes": "Clause split from a follow-up planning turn.",
    },
    {
        ...
        "notes": "Clause split from a realistic pricing/uncertainty turn.",
    },
    {
        ...
        "notes": "Clause split from a vague rep response.",
    },
    {
    ...
    },
    {
        ...
        "notes": "Conditional clause from a realistic expansion-upside turn.",
    },
    {
        ...
        "notes": "Emotion benchmark confusion case reused as an ambiguity label.",
    },
    {
        ...
        "notes": "Emotion benchmark confusion case reused as a commercial ambiguity label.",
    },
    {
        "id": "unc_support_concern_seed_001",
        "source_file": "data/signal_engine_2_0/emotion_benchmark/sample_emotion_cases.jsonl",
        "domain": "support",
        "text": "I'm concerned the rollback plan still hasn't been confirmed. Please send the update to ops@northwind.example when you have it.",
        "signal_family": "uncertainty_hedging",
        ...
        "notes": "Emotion benchmark concern case; email is redacted in the saved dataset.",
    },
    {
        "id": "neut_sales_opening_full_001",
        "source_file": "data/signal_engine_2_0/sample_sales.json",
        "domain": "sales",
        ...
        "notes": "Opening rep turn from the sales sample.",
    },
    {
        ...
        "notes": "Short neutral opener clause.",
    },
    {
        ...
        "notes": "Emotion benchmark neutral case reused as an operational status label.",
    },
    {
        ...
        "notes": "Clause split from a neutral operational update.",
    },
    {
        ...
        "notes": "Emotion benchmark neutral case reused as a process-update label.",
    },
    {
        ...
        "notes": "Short neutral intro clause.",
    },
    {
        "id": "neut_account_status_meeting_001",
        "source_file": "data/signal_engine_2_0/emotion_benchmark/sample_emotion_cases.jsonl",
        "domain": "account_management",
    ...
    },
    {
        ...
        "notes": "Neutral attachment reference clause.",
    },
    {
        ...
        "notes": "Clause split from a realistic recovery-plan turn.",
    },
    {
        ...
        "notes": "Short acknowledgement clause from the sales sample.",
    },
    {
        ...
        "notes": "Neutral operational clause from the sales status case.",
    },
)


def _load_source_texts(path: Path) -> list[str]:
    if path.suffix == ".json":
        payload = json.loads(path.read_text(encoding="utf-8"))
        segments = payload.get("transcript_segments") or payload.get("messages") or []
        return [
            str(segment.get("text") or segment.get("message") or segment.get("content") or "")
...
def build_human_reviewed_rows(root: Path | None = None) -> list[dict[str, Any]]:
    ...
    for spec in SEED_SPECS:
        ...
        if source_file not in source_cache:
            source_cache[source_file] = _load_source_texts(source_path)
        if not any(str(spec["text"]) in candidate for candidate in source_cache[source_file]):
            raise ValueError(f"Seed text not found in source file {source_file}: {spec['id']}")

        redacted = redact_pii_text(str(spec["text"]))
        rows.append(
            {
                "id": spec["id"],
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build a small human-reviewed signal-family label set from committed local fixtures."
    )
    parser.add_argument(
        "--out",
        default=str(ROOT / "data" / "nlp_research" / "human_reviewed_signal_labels.jsonl"),
        help="Path to the JSONL label output.",
    )
    args = parser.parse_args(argv)

    rows = build_human_reviewed_rows()
    ...
    counts = dict(Counter(row["signal_family"] for row in rows))
    print(
        json.dumps(
            {
                "status": "ok",
                ...
                "class_counts": counts,
                "redacted_rows": sum(1 for row in rows if row["pii_redacted"]),
            },
            indent=2,
        )
    )
