...
readiness-canonical:
	$(PYTHON) scripts/build_canonical_readiness.py

control-room-status: readiness-canonical
	$(PYTHON) scripts/build_control_room_status.py

training-control-room-check: control-room-status
