    ...
    *,
    ...
    comparison_summary = {
        ...
        "notes": [
            ...
            (
                "No prior sidecar outputs were found for this case yet."
                if not summaries
                else "Pairwise summaries only include models with saved scored_rows.csv outputs."
            ),
        ],
    }
    ...
    if runtime_summary["models"]:
        ...
        lines.append("- No saved sidecar model outputs were present yet.")
    if pairwise:
