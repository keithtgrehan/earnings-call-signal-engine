...
- Tightened audio interpretation wording so it stays tied to measured pause/filler/qualification cues and explicitly avoids intent/confidence inference.
...
- Visual output is much harder to overread as corroboration.
...
- Letter and financial-anchor rows still do not have timed media alignment.
...
- No visual row should be read as model-backed corroboration, contradiction, intent inference, or emotional inference.
