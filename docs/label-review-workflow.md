...
2. Share the CSV or Markdown packet with a second reviewer
3. Fill only:
   - `reviewer_label`
   - `reviewer_confidence`
   - `reviewer_notes`
4. Normalize the reviewed CSV with `python scripts/import_second_review_labels.py`
5. Run `python scripts/evaluate_label_agreement.py`
