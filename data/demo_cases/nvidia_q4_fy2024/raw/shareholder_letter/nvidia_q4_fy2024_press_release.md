...
URL Source: https://investor.nvidia.com/news/press-release-details/2024/NVIDIA-Announces-Financial-Results-for-Fourth-Quarter-and-Fiscal-2024/

Markdown Content:
# NVIDIA Corporation - NVIDIA Announces Financial Results for Fourth Quarter and Fiscal 2024
[Skip to main content](https://investor.nvidia.com/news/press-release-details/2024/NVIDIA-Announces-Financial-Results-for-Fourth-Quarter-and-Fiscal-2024/#main-content)

[](https://investor.nvidia.com/news/press-release-details/2024/NVIDIA-Announces-Financial-Results-for-Fourth-Quarter-and-Fiscal-2024/)[](javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("lnkPostback", "", true, "", "", false, true)))

[Skip to main content](https://investor.nvidia.com/news/press-release-details/2024/NVIDIA-Announces-Financial-Results-for-Fourth-Quarter-and-Fiscal-2024/#maincontent)
...
*   [Stock Info](https://investor.nvidia.com/stock-info/stock-quote-and-chart/default.aspx)
    *   [Stock Quote & Chart](https://investor.nvidia.com/stock-info/stock-quote-and-chart/default.aspx)
    *   [Historical Price Lookup](https://investor.nvidia.com/stock-info/historical-price-lookup/default.aspx)
    *   [Investment Calculator](https://investor.nvidia.com/stock-info/investment-calculator/default.aspx)
    *   [Fundamentals](https://investor.nvidia.com/stock-info/fundamentals/default.aspx)
    *   [Analyst Coverage](https://investor.nvidia.com/stock-info/analyst-coverage/default.aspx)

*   [Financial Info](https://investor.nvidia.com/financial-info/financial-reports/default.aspx)
    *   [Financial Reports](https://investor.nvidia.com/financial-info/financial-reports/default.aspx)
    *   [SEC Filings](https://investor.nvidia.com/financial-info/sec-filings/default.aspx)
    *   [Quarterly Results](https://investor.nvidia.com/financial-info/quarterly-results/default.aspx)
    *   [Annual Reports and Proxies](https://investor.nvidia.com/financial-info/annual-reports-and-proxies/default.aspx)
    *   [Annual Meeting](https://investor.nvidia.com/financial-info/Annual-Meeting/default.aspx)

*   [Governance](https://investor.nvidia.com/governance/management-team/default.aspx)
    *   [Management Team](https://investor.nvidia.com/governance/management-team/default.aspx)
    *   [Board of Directors](https://investor.nvidia.com/governance/board-of-directors/default.aspx)
    *   [Governance Documents](https://investor.nvidia.com/governance/governance-documents/default.aspx)
    *   [Committee Composition](https://investor.nvidia.com/governance/committee-composition/default.aspx)
    *   [Contact the Board](https://investor.nvidia.com/governance/contact-the-board/default.aspx)

*   [Investor Resources](https://investor.nvidia.com/investor-resources/download-library/default.aspx)
    *   [Download Library](https://investor.nvidia.com/investor-resources/download-library/default.aspx)
    *   [Contact Investor Relations](https://investor.nvidia.com/investor-resources/contact-investor-relations/default.aspx)
    *   [Request Information](https://investor.nvidia.com/investor-resources/request-information/default.aspx)
    *   [FAQs](https://investor.nvidia.com/investor-resources/faqs/default.aspx)
    *   [Email Alerts](https://investor.nvidia.com/investor-resources/email-alerts/default.aspx)
    *   [RSS](https://investor.nvidia.com/investor-resources/rss/default.aspx)
    *   [Application Catalog](https://www.nvidia.com/en-us/gpu-accelerated-applications/)
...
[View all news](https://investor.nvidia.com/investors/news/default.aspx)

### NVIDIA Announces Financial Results for Fourth Quarter and Fiscal 2024

February 21, 2024

[Download this Press Release PDF Format (opens in new window)](https://investor.nvidia.com/news/press-release-details/2024/NVIDIA-Announces-Financial-Results-for-Fourth-Quarter-and-Fiscal-2024/)
...
_per share)_**Q4 FY24****Q3 FY24****Q4 FY23****Q/Q****Y/Y**
...
*   Launched, in collaboration with Google, [optimizations across NVIDIA’s data center and PC AI platforms for Gemma](https://blogs.nvidia.com/blog/google-gemma-llm-rtx-ai-pc), Google’s groundbreaking open language models.
*   Expanded its [strategic collaboration with Amazon Web Services](https://nvidianews.nvidia.com/news/aws-nvidia-strategic-collaboration-for-generative-ai) to host NVIDIA® DGX™ Cloud on AWS.
*   Announced that [Amgen will use the NVIDIA DGX SuperPOD](https://blogs.nvidia.com/blog/genomics-ai-amgen-superpod/)™ to power insights into drug discovery, diagnostics and precision medicine.
*   Announced[NVIDIA NeMo™ Retriever](https://nvidianews.nvidia.com/news/nemo-retriever-generative-ai-microservice), a generative AI microservice that lets enterprises connect custom large language models with enterprise data to deliver highly accurate responses for AI applications.
*   Introduced [NVIDIA MONAI™ cloud APIs](https://blogs.nvidia.com/blog/monai-cloud-apis-rsna/) to help developers and platform providers integrate AI into their medical-imaging offerings.
*   Announced that [Singtel will bring generative AI services to Singapore](https://blogs.nvidia.com/blog/singtel-sovereign-ai/) through energy-efficient data centers that the telco is building with NVIDIA Hopper™ architecture GPUs.
*   Introduced [plans with Cisco](https://nvidianews.nvidia.com/news/cisco-nvidia-secure-ai-infrastructure) to help enterprises quickly and easily deploy and manage secure AI infrastructure.
*   Supported the [National Artificial Intelligence Research Resource pilot program](https://blogs.nvidia.com/blog/national-ai-research-resource-pilot/), a major step by the U.S. government toward a shared national research infrastructure.
...
*   Launched [GeForce RTX™ 40 SUPER Series GPUs](https://nvidianews.nvidia.com/news/geforce-rtx-40-super-series), starting at $599, which support the latest NVIDIA RTX™ technologies, including DLSS 3.5 Ray Reconstruction and NVIDIA Reflex.
*   Announced generative AI capabilities for its installed base of over 100 million RTX AI PCs, including [Tensor-RT™ LLM](https://developer.nvidia.com/blog/optimizing-inference-on-llms-with-tensorrt-llm-now-publicly-available) to accelerate inference on large language models, and [Chat with RTX,](https://blogs.nvidia.com/blog/chat-with-rtx-available-now/) a tech demo that lets users personalize a chatbot with their own content.
*   Introduced [microservices for the NVIDIA Avatar Cloud Engine](https://nvidianews.nvidia.com/news/ace-avatar-cloud-engine-microservices), allowing game and application developers to integrate state-of-the-art generative AI models into non-playable characters.
*   Reached the milestone of [500 AI-powered RTX games and applications](https://www.nvidia.com/en-us/geforce/news/rtx500-celebration-dlss-ray-tracing-new-games-win-prizes/) utilizing NVIDIA DLSS, ray tracing and other NVIDIA RTX technologies.
...
*   Announced [adoption of NVIDIA Omniverse](https://blogs.nvidia.com/blog/omniverse-automotive-configurator-developer-ecosystem/)™ by the global automotive-configurator ecosystem.
*   Announced the [NVIDIA RTX 2000 Ada Generation GPU](https://blogs.nvidia.com/blog/rtx-2000-ada/), bringing the latest AI, graphics and compute technology to compact workstations.
...
*   Announced [further adoption of its NVIDIA DRIVE® platform](https://blogs.nvidia.com/blog/ai-automotive-innovation-ces/), with Great Wall Motors, ZEEKR and Xiaomi using DRIVE Orin™ to power intelligent automated-driving systems and Li Auto selecting DRIVE Thor™ as its centralized car computer.
...
NVIDIA will conduct a conference call with analysts and investors to discuss its fourth quarter and fiscal 2024 financial results and current financial prospects today at 2 p.m. Pacific time (5 p.m. Eastern time). A live webcast (listen-only mode) of the conference call will be accessible at NVIDIA’s investor relations website, [https://investor.nvidia.com](https://investor.nvidia.com/). The webcast will be recorded and available for replay until NVIDIA’s conference call to discuss its financial results for its first quarter of fiscal 2025.
...
[sjankowski@nvidia.com](mailto:sjankowski@nvidia.com)[mmangalindan@nvidia.com](mailto:mmangalindan@nvidia.com)
...
_GAAP gross margin_ _76.0_ _%_ _74.0_ _%_ _63.3_ _%_ _72.7_ _%_ _56.9_ _%_
...
**_Non-GAAP gross margin_****_76.7_****_%_****_75.0_****_%_****_66.1_****_%_****_73.8_****_%_****_59.2_****_%_**
...
A photo accompanying this announcement is available at [https://www.globenewswire.com/NewsRoom/AttachmentNg/38343cb8-8bc8-42b0-aa76-e3d280ae5507](https://www.globenewswire.com/NewsRoom/AttachmentNg/38343cb8-8bc8-42b0-aa76-e3d280ae5507)

![Image 2](https://www.globenewswire.com/newsroom/ti?nf=OTA0MTE3OSM2MDc5OTk1IzIwMDY5MTI=)

![Image 3](https://ml.globenewswire.com/media/ZmVjOGUyOWItMjA3My00OTc4LWE5NGEtZDBlNGM2Y2E5ZmM5LTEwMTg0ODU=/tiny/NVIDIA-CORPORATION.png)
[![Image 4: Primary Logo](https://ml.globenewswire.com/media/ad3b9553-6933-40b1-adfd-2ed199cd141c/small/nvidia-logo-jpg.jpg)](https://www.globenewswire.com/NewsRoom/AttachmentNg/ad3b9553-6933-40b1-adfd-2ed199cd141c)

##### NVIDIA Corporate Offices

[![Image 5](https://ml.globenewswire.com/media/38343cb8-8bc8-42b0-aa76-e3d280ae5507/medium/nvidia-corporate-offices.png)](https://www.globenewswire.com/NewsRoom/AttachmentNg/38343cb8-8bc8-42b0-aa76-e3d280ae5507/en)
...
*   [Email Alerts](https://investor.nvidia.com/investor-resources/email-alerts/default.aspx)
*   [RSS](https://investor.nvidia.com/investor-resources/rss/default.aspx)
*   [Request Printed Materials](https://investor.nvidia.com/investor-resources/request-information/default.aspx)
*   [Download Library](https://investor.nvidia.com/investor-resources/download-library/default.aspx)
...
Mailing Lists *
- [x] SEC Filing - [x] Presentation - [x] Event - [x] End of Day Stock Quote

![Image 6](https://investor.nvidia.com/q4api/v4/captcha?clientId=_ctrl0_ctl36_UCCaptcha)
...
[Subscribe](https://nvidianews.nvidia.com/alerts)

Follow NVIDIA

[![Image 7: Facebook](https://s201.q4cdn.com/141608511/files/design/social/Facebook-icon.svg)](https://www.facebook.com/NVIDIA/)[![Image 8: Twitter](https://s201.q4cdn.com/141608511/files/design/social/Twitter-icon.svg)](https://twitter.com/nvidia)[![Image 9: Youtube](https://s201.q4cdn.com/141608511/files/design/social/You-Tube-icon.svg)](https://www.youtube.com/user/nvidia)[![Image 10: Twitch](https://s201.q4cdn.com/141608511/files/design/social/Twitch-icon.svg)](https://www.twitch.tv/nvidia)

Investors and others should note that we announce material financial information to our investors using our investor relations website, press releases, SEC filings and public conference calls and webcasts. We intend to use our[@NVIDIA](https://twitter.com/NVIDIA)Twitter account,[NVIDIA Facebook](https://www.facebook.com/NVIDIA)page,[NVIDIA LinkedIn](https://www.linkedin.com/company/nvidia?trk=hb_tab_compy_id_3608)page and company[blog](https://blogs.nvidia.com/)as a means of disclosing information about our company, our services and other matters and for complying with our disclosure obligations under Regulation FD. The information we post through these social media channels may be deemed material. Accordingly, investors should monitor these accounts and the blog, in addition to following our press releases, SEC filings and public conference calls and webcasts. This list may be updated from time to time.

[![Image 11](https://www.nvidia.com/etc/designs/nvidiaGDC/clientlibs_base/images/country-selector/us.png)USA - United States](https://www.nvidia.com/en-us/location-selector/)
...
[Powered By Q4 Inc.5.176.0.2(opens in new window)](https://www.q4inc.com/Powered-by-Q4/)
